...
// const MyStatefulEditor = ({ value, handleChange, placeholder, onBlur }) => {
//   const [textValue, setTextValue] = useState([])

//   useEffect(() => {
//     console.log(value)
//     if (value) {
//       setTextValue(RichTextEditor.createValueFromString(value, 'markdown'))
//     } else {
...
//       // This is here to demonstrate using `.toString()` but in a real app it
//       // would be better to avoid generating a string on each change.
//       handleChange(value.toString('markdown'));
//     // }
//   }
